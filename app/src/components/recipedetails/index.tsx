...
import { getRecipeObjectByIdOrNull } from "../../utility/utils";

export default function RecipeDetailsPage({ recipeCollection }: any) {
  //   useScrollToTop();
  ...
  console.log(recipeCollection, "thissniru");
  useEffect(() => {
